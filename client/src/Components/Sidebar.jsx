...
export default function Sidebar() {
  ...
  return (
    <div className='md:w-[250px] md:h-[99.3%] my-auto     flex flex-col  gap-5    p-3 rounded-r-md bg-slate-700  '>
        ...
        <button className='text-xl bg-red-600 rounded-lg py-2    font-medium flex items-center px-3  gap-2  hover:font-semibold hover:scale-95 transition-all'> <FaSignOutAlt />  Sign out</button>
